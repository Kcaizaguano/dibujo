...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private void showLineWidthDialog() {
        ...
        dialogLineWidth.setTitle("Elija el ancho de linea");
    ...
    private void requestPermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            Toast.makeText(this, "El permiso Escribir almacenamiento externo nos permite almacenar imágenes. Permita este permiso en la configuración de la aplicación.", Toast.LENGTH_LONG).show();
        } else {
    ...
    void showColorDialog() {
        ...
        currentAlerDialog.setView(view);
        currentAlerDialog.setTitle("ELija un color");
